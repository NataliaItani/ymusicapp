...
import io.ymusic.app.local_player.AbsPlayerFragment;
import io.ymusic.app.local_player.CardPlayerFragment;
import io.ymusic.app.local_player.MiniPlayerFragment;
...
//            super.setLightStatusbar(enabled);
    ...
    private void animateNavigationBarColor(int color) {
        if (navigationBarColorAnimator != null) navigationBarColorAnimator.cancel();
        navigationBarColorAnimator = ValueAnimator.ofArgb(getWindow().getNavigationBarColor(), color).setDuration(ViewUtil.PHONOGRAPH_ANIM_TIME);
