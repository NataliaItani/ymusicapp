...
import io.ymusic.app.local_player.helper.ShuffleHelper;
import io.ymusic.app.local_player.helper.StopWatch;
import io.ymusic.app.local_player.model.Song;
import io.ymusic.app.local_player.provider.HistoryStore;
import io.ymusic.app.local_player.provider.MusicPlaybackQueueStore;
import io.ymusic.app.local_player.provider.SongPlayCountStore;
import io.ymusic.app.local_player.service.notification.PlayingNotification;
import io.ymusic.app.local_player.service.notification.PlayingNotificationImpl;
import io.ymusic.app.local_player.service.notification.PlayingNotificationImpl24;
import io.ymusic.app.local_player.service.playback.Playback;
import io.ymusic.app.util.AppUtils;
import io.ymusic.app.util.MusicUtil;
import io.ymusic.app.util.glide.BlurTransformation;
...
public class MusicService extends Service implements Playback.PlaybackCallbacks {
    ...
    public static final String ACTION_TOGGLE_PAUSE = APP_PACKAGE_NAME + ".togglepause";
    public static final String ACTION_PLAY = APP_PACKAGE_NAME + ".play";
    public static final String ACTION_PAUSE = APP_PACKAGE_NAME + ".pause";
    public static final String ACTION_STOP = APP_PACKAGE_NAME + ".stop";
    public static final String ACTION_SKIP = APP_PACKAGE_NAME + ".skip";
    public static final String ACTION_REWIND = APP_PACKAGE_NAME + ".rewind";
    public static final String ACTION_QUIT = APP_PACKAGE_NAME + ".quitservice";
    public static final String ACTION_PENDING_QUIT = APP_PACKAGE_NAME + ".pendingquitservice";

    // do not change these three strings as it will break support with other apps (e.g. last.fm scrobbling)
    public static final String META_CHANGED = APP_PACKAGE_NAME + ".metachanged";
    public static final String QUEUE_CHANGED = APP_PACKAGE_NAME + ".queuechanged";
    public static final String PLAY_STATE_CHANGED = APP_PACKAGE_NAME + ".playstatechanged";

    public static final String REPEAT_MODE_CHANGED = APP_PACKAGE_NAME + ".repeatmodechanged";
    public static final String SHUFFLE_MODE_CHANGED = APP_PACKAGE_NAME + ".shufflemodechanged";
    public static final String MEDIA_STORE_CHANGED = APP_PACKAGE_NAME + ".mediastorechanged";
    ...
    public void onCreate() {
        ...
        getContentResolver().registerContentObserver(MusicUtil.getCollection(), true, mediaStoreObserver);
        ...
        sendBroadcast(new Intent("io.awesome.gagtube.PHONOGRAPH_MUSIC_SERVICE_CREATED"));
    }
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("io.awesome.gagtube.PHONOGRAPH_MUSIC_SERVICE_DESTROYED"));
    }
    ...
    private void updateMediaSessionMetaData() {
        ...
        final Point screenSize = AppUtils.getScreenSize(MusicService.this);
    ...
    private void playSongAtImpl(int position) {
        if (openTrackAndPrepareNextAt(position)) {
            ...
            Toast.makeText(this, getResources().getString(R.string.player_stream_failure), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void sendPublicIntent(@NonNull final String what) {
        final Intent intent = new Intent(what.replace(APP_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
