...
public class NewAndHotFragment extends BaseListInfoFragment<KioskInfo> {
    ...
    public static NewAndHotFragment getInstance(final int serviceId) throws ExtractionException {
        return getInstance(serviceId, NewPipe.getService(serviceId).getKioskList().getDefaultKioskId());
    }

    public static NewAndHotFragment getInstance(final int serviceId, final String kioskId) throws ExtractionException {
        final NewAndHotFragment instance = new NewAndHotFragment();
        ...
        instance.kioskTranslatedName = "New & hot";
        return instance;
    }

    public NewAndHotFragment() {
    }
