...
public class AlbumFragment extends BaseFragment implements LoaderManager.LoaderCallbacks<List<Song>> {
    @BindView(R.id.items_list)
    RecyclerView recyclerView;
    @BindView(R.id.empty_state_view)
    View emptyView;

    // The ArtistFragment and the AlbumFragment are using the same Adapter
    ...
    private void initRecyclerView() {
        albumAdapter = new ArtistAdapter(activity, songList, R.layout.list_song_item, SongsFragment.SONG_TYPE.ALBUM, null);
    ...
    private void showEmptyViews() {
        emptyView.setVisibility(albumAdapter.getDataSet().isEmpty() ? View.VISIBLE : View.GONE);
        recyclerView.setVisibility(albumAdapter.getDataSet().isEmpty() ? View.GONE : View.VISIBLE);
    }
    ...
    public void onLoadFinished(@NonNull Loader<List<Song>> loader, List<Song> data) {
        albumAdapter.swapDataSet(data);
        showEmptyViews();
    }

    @Override
    public void onLoaderReset(@NonNull Loader<List<Song>> loader) {
        albumAdapter.swapDataSet(new ArrayList<>());
        showEmptyViews();
    }
    ...
    private static class AsyncSongLoader extends WrappedAsyncTaskLoader<List<Song>> {
        ...
        public List<Song> loadInBackground() {
            return SongLoader.getAllAlbums(getContext());
        }
    }
}