package io.ymusic.app.database.subscription;

import static io.ymusic.app.database.subscription.SubscriptionEntity.SUBSCRIPTION_SERVICE_ID;
import static io.ymusic.app.database.subscription.SubscriptionEntity.SUBSCRIPTION_TABLE;
import static io.ymusic.app.database.subscription.SubscriptionEntity.SUBSCRIPTION_URL;
...
public class SubscriptionEntity {
    ...
    private int serviceId = ServiceList.SoundCloud.getServiceId();
